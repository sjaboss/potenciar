<x-app-layout>
    <div class="container ">
        <br>
        <div
            class="w-full p-4 text-center bg-slate-50 border border-gray-200 rounded-lg shadow sm:p-8 ">
            <h5 class="mb-2 text-3xl bg-gray-300 p-6  rounded-t-lg  shadow font-bold text-gray-900 dark:text-white">Potenciar trabajo</h5>
            <p class="mb-3 text-base text-left text-gray-500 sm:text-lg dark:text-gray-400">Eliminar persona del sistema</p>
            <hr><br>
...
<br>
            ...
            <form action="">
                <div class="text-left pt-2">
                    ...
                    <a  href="{{ route('personas.destroy', $persona->id) }}"
