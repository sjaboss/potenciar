    ...
    <div class="container ">
        ...
        <section class="bg-slate-50 ">
            <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                ...
                <h2 class="mb-4 text-xl font-bold text-gray-900 ">Modificación del estado en la fecha: {{ date('d/m/Y - h:i ', strtotime($persona->created_at)) }} </h2>
                <h2 class="mb-4 text-xl font-bold text-gray-900 ">Por el usuario: {{ $persona->usu_ing }}{{ $persona->usu_mod }}{{ $persona->usu_sup }}     </h2>
                <br>
                ...
                <form  novalidate>            
                    <div class="grid md:grid-cols-2 md:gap-6">
                        <div class="relative z-0 w-full mb-6 group">
                            <input disabled value="{{ $persona->nombres }}" autocomplete="off"type="text" name="nombres"
                                id="nombres"
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <input disabled value="{{ $persona->apellidos }}" autocomplete="off" type="text" name="apellido"
                                id="apellido"
                                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                placeholder=" " required />
                            @error('apellido')
                    ...
                    <div class="grid md:grid-cols-2 md:gap-6">
                        <div class="relative z-0 w-full mb-6 group">
                            <input disabled value="{{ $persona->doc }}" type="text" name="documento" id="documento"
                                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                placeholder=" " required />
                            @error('documento')
                                <div class="p-1 flex items-center  m-1 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50"
                    ...
                    <div class="grid md:grid-cols-2 md:gap-6">
                        <div class="relative z-0 w-full mb-6 group">
                            <input  disabled value="{{ $persona->email }}" type="email" name="correo" id="correo"
                                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                placeholder=" " required />
                            @error('correo')
                                <div class="p-1 flex items-center  m-1 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50"
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <input disabled  value="{{ $persona->telefono }}" type="text" name="telefono" id="telefono"
                                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                placeholder=" " required />
                            @error('telefono')
                                <div class="p-1 flex items-center  m-1 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50"
                    ...
                    <div class="grid md:grid-cols-2 md:gap-6">
                        <div class="relative z-0 w-full mb-6 group">
                            <select disabled  id="prov" name="prov"
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <input disabled  value="{{ $persona->partido }}" type="text" name="partido" id="partido"
                                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                placeholder=" " required />
                            @error('partido')
                                <div class="p-1 flex items-center  m-1 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50"
                    ...
                    <div class="grid md:grid-cols-2 md:gap-6">
                        <div class="relative z-0 w-full mb-6 group">
                            <input disabled  value="{{ $persona->localidad }}" type="text" name="localidad" id="localidad"
                                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                placeholder=" " required />
                            @error('localidad')
                                <div class="p-1 flex items-center  m-1 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50"
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <input disabled  value="{{ $persona->direccion }}" type="text" name="direccion" id="direccion"
                                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                placeholder=" " required />
                            @error('direccion')
                                <div class="p-1 flex items-center  m-1 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50"
                    ...
                    <div class="grid md:grid-cols-2 md:gap-6">
                        <div class="relative z-0 w-full mb-6 group">
                            <input disabled  value="{{ $persona->cp }}" type="text" name="codigo" id="codigo"
                                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                placeholder=" " required />
                            @error('codigo')
                                <div class="p-1 flex items-center  m-1 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50"
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <input disabled  value="{{ $persona->referente }}" type="text" name="referente" id="referente"
                                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                placeholder=" " required />
                            @error('referente')
                                <div class="p-1 flex items-center  m-1 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50"
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <select disabled  name="unidad" id="unidad"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                    ...
                    <div class="grid md:grid-cols-2 md:gap-6">
                        <div class="relative z-0 w-full mb-6 group">
                            <div class="relative z-0 w-full mb-6 group">
                                <input disabled  value="{{ $persona->fec_ini }}" type="date" name="f_inicio"
                                    id="f_inicio"
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <input  disabled value="{{ $persona->fec_alta }}" type="date" name="f_alta" id="f_alta"
                                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                placeholder=" " required />
                            @error('f_alta')
                                <div class="p-1 flex items-center  m-1 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50"
                    ...
                    <div>
                        <a href="{{ route('personas.historial') }}"
